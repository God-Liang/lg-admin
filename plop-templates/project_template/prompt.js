...
module.exports = {
  ...
  actions: data => {
    ...
    const actions = [
      {
        type: 'add',
        path: `src/views/${project}/${file}/${name}/index.vue`,
      ...
      {
        type: 'add',
        path: `src/views/${project}/${file}/columnsConst/modules/${name}Const.js`,
      ...
      {
        type: 'add',
        path: `src/views/${project}/${file}/${name}/modules/detail.vue`,
    ...
    if (data.wantIndex) {
      actions.push({
        type: 'add',
        path: `src/views/${project}/${file}/columnsConst/index.js`,
